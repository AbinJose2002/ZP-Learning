...
interface locationData {
    ...
    region: string;
    country: string;
    localtime: string | undefined | Date;
}
    ...
    const searchWeather = async () => {
        try {
            ...
            if(weatherRes.status === 200){
                ...
                const dateStr: String | Date = location?.localtime; // e.g., "2025-06-09 15:30"
...
>
  <div className="row text-white">
    ...
    <div className="col-md-4 col-6 mb-3">
      <div className="p-3 border rounded bg-primary" style={{ minHeight: "150px" }}>
